...
const ResearchComponent4 = ({ setDragging }) => {
    ...
    return (
        <>
            <div className="bg-[#2d363d] rounded-2xl h-[390px] text-[14px] font-semibold relative pb-5">
                ...
                <div className="border-0 border-b border-b-[#4E4E4E]">
                    <Chart height={270} options={state5.options} series={state5.series} type={'bar'} />
                </div>
                <p className='text-center mt-3 cursor-pointer text-[#a3a3a3]' onClick={() => navigate('/dashboard/research/organiccompetitors')}>View all competitors</p>
            </div>
        </>
    );
};
