...
const OrganicFilters = () => {
    ...
    return (
        <div className="py-5 px-3">
            ...
            {showMore && (
                <div className='block'>
                    <p className='flex items-center justify-between mt-4'>Rank Change
                        <Tooltip title="Lorem Ipsum is simply dummy text of the printing and typesetting industry." placement="bottom">
                            <IconButton>
                                <HiOutlineInformationCircle className='cursor-pointer text-[#a3a3a3]' size={18} />
                            </IconButton>
                    ...
                    <div className="flex items-center">
                        <input type="text" className='border border-[#4a5258] outline-none bg-transparent px-2 py-2 mt-1 w-full text-sm' placeholder='-99' />
                        <input type="text" className='border border-[#4a5258] outline-none bg-transparent px-2 py-2 mt-1 w-full text-sm' placeholder='99' />
                    </div>
                    ...
                    <div className="flex items-center">
                        <input type="text" className='border border-[#4a5258] outline-none bg-transparent px-2 py-2 mt-1 w-full text-sm' placeholder='$0' />
                        <input type="text" className='border border-[#4a5258] outline-none bg-transparent px-2 py-2 mt-1 w-full text-sm' placeholder='$1000' />
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                        <input type="radio" id="adult1" name="adult" value="Adult Filters (324 Hidden)" className="w-3 h-3 text-[#aaaaaa] bg-[#2d363d] border-gray-300 rounded dark:bg-transparent dark:border-gray-600 outline-none" />
                        <label htmlFor="adult1">Adult Filters (324 Hidden)</label>
                    </div>
