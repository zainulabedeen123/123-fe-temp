...
const Clicks = () => {
    // Note: Separate Files for Change will be required ie Chart and Overview for both SEO and PPC
    ...
    const isSEO = location.pathname.includes('seoclicks');
    const isPPC = location.pathname.includes('ppcclicks');
    ...
    return (
        <>
            <div className="flex items-center gap-2 px-2">
                ...
                <p className='text-[#f3941d]'>{isSEO ? 'Est Monthly SEO Clicks' : 'Est Monthly PPC Clicks'}</p>
            </div>
