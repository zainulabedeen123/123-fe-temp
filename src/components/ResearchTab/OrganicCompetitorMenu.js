...
const OrganicCompetitorMenu = ({ competitors, selectedCompetitors, toggleCompetitor }) => {
    return (
                ...
                >
                    ...
                    <div className="flex items-center gap-2 pl-3">
                        <div>
                            ...
                            <p className="text-[#a3a3a3] text-sm">SEO Keywords: {competitor.numberofKeywords}</p>
                        </div>
                    </div>
...
export default OrganicCompetitorMenu;
