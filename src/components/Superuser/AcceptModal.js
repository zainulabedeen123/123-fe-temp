...
import { Modal, ModalContent, ModalBody, ModalFooter, Button, Input, Select, SelectItem, SelectSection } from "@nextui-org/react";

const AcceptModal = ({ isOpen, onClose, user }) => {
                ...
                <div className="relative bg-[#2D363D] rounded-3xl p-6">
                    <ModalBody className="space-y-4">
                        ...
                        <div className="flex items-center">
                            <label className="w-[125px] text-neutral-50 text-sm font-normal">Email Address</label>
                            <Input
                                label=""
                                classNames={{
                                    inputWrapper: [
