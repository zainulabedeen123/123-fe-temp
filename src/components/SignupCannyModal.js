...
const SignupCannyModal = ({ isOpen, onClose }) => {
  return (
    <Modal
      isOpen={isOpen}
      ...
      <ModalContent>
        <div className="relative bg-[#2D363D] rounded-3xl">
          <ModalBody className="space-y-2 p-6">
            <p className='text-sm font-normal mb-1 text-center'>We use Canny to collect feedback from users like you. Sign up to post and vote.</p>
            <h2 className="text-center text-xl font-semibold text-white">Sign up to Canny with:</h2>
            ...
            <div className="text-center text-[#a3a3a3]">Already have an account? <span className="underline cursor-pointer">Login</span></div>
          </ModalBody>
...
export default SignupCannyModal;
