...
const ColumnsSelector = ({ selectedSavedFilterSet, setSelectedSavedFilterSet, selectedCompetitor, setSelectedCompetitor, selectedBrand, setSelectedBrand, selectedStock, setSelectedStock, selectedStatus, setSelectedStatus, selectedDiff, setSelectedDiff }) => {
    return (
        <Dropdown>
            <DropdownTrigger>
                <Button
                    ...
                    radius="sm"
                    variant="flat"
                    endContent={<FaAngleDown className='text-[#a3a3a3]' />}
