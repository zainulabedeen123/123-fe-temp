...
const FilterSelector = () => {
    ...
    const [selectedPosition, setSelectedPosition] = useState("Select an option");
    const [selectedProductsMatched, setSelectedProductsMatched] = useState("Select an option");
                ...
                <DropdownSection title="Options">
                    ...
                    <DropdownItem isReadOnly>
                        ...
                        <Select
                            ...
                            onSelectionChange={(key) => setSelectedPosition(Array.from(key)[0])}
                            classNames={{
                                trigger: "w-full rounded-md bg-transparent border border-[#a3a3a3] text-white px-4 py-2 mt-2",
                                listbox: "bg-[#2D363D]",
                                popoverContent: "bg-[#2D363D] text-[#a3a3a3] min-w-[200px]",
                            ...
                            renderValue={() => selectedPosition}
                        >
                            <SelectItem key="Select an option">Select an option</SelectItem></Select>
                    </DropdownItem>
                    ...
                    <DropdownItem isReadOnly>
                        ...
                        <Select
                            selectedKeys={[selectedProductsMatched]}
                            onSelectionChange={(key) => setSelectedProductsMatched(Array.from(key)[0])}
                            classNames={{
                                trigger: "w-full rounded-md bg-transparent border border-[#a3a3a3] text-white px-4 py-2 mt-2",
                                listbox: "bg-[#2D363D]",
                                popoverContent: "bg-[#2D363D] text-[#a3a3a3] min-w-[200px]",
                            ...
                            aria-label="Products Matched"
                            renderValue={() => selectedProductsMatched}
                        >
                            <SelectItem key="Select an option">Select an option</SelectItem>
                        </Select>
                    </DropdownItem>
                    ...
                    <DropdownItem isReadOnly>
                        ...
                        >
                            <SelectItem key="Select an option">Select an option</SelectItem>
                            <SelectItem key="Competitive Price">Competitive Price</SelectItem>
                            <SelectItem key="Same Price">Same Price</SelectItem>
                            <SelectItem key="Overpriced">Overpriced</SelectItem>
                        </Select>
                    </DropdownItem>
                </DropdownSection>
