        ...
        },
        {
            ...
            render: (value, row, index) => (
                <div className="flex items-center gap-2 w-[42px]">
                    ...
                    {products[index].isActive ? <FiEye className="text-[#a3a3a3]" size={18} onClick={() => toggleActive(index)} /> : <FiEyeOff className="text-[#a3a3a3]" size={18} onClick={() => toggleActive(index)} />}
                </div>
            )
        }
    ];
...
export default OverpricedProducts;
